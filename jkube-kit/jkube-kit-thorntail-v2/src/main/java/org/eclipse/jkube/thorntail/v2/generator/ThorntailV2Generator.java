...
public class ThorntailV2Generator extends JavaExecGenerator {
    ...
    public boolean isApplicable(List<ImageConfiguration> configs) {
        return shouldAddGeneratedImageConfiguration(configs)
                && (JKubeProjectUtil.hasPlugin(getProject(), "io.thorntail", "thorntail-maven-plugin") || JKubeProjectUtil.hasDependency(getProject(), "io.thorntail", "thorntail-gradle-plugin") )
